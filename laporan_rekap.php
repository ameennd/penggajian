...
// Query untuk menghitung rekap keuangan dan kehadiran
$query = "
    SELECT 
        karyawan.jabatan,
        ...
        SUM(
            CASE 
                WHEN absensi.id_karyawan IS NOT NULL THEN 1
                ELSE 0
            END
        ) AS total_kehadiran,
        SUM(
            CASE 
                WHEN absensi.id_karyawan IS NOT NULL THEN (karyawan.gaji_pokok / 20) 
                ELSE 0
            END
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Rp <?= number_format($row['total_gaji_pokok'], 2, ',', '.') ?></td>
